...
연구 디자인에 따라 통계 처리가 자동 분기되는 Table 1 생성기.
...
- Post-hoc pairwise comparison (≥3군 omnibus 후) — v0.2.0+ 계획
...
- [MediStat-EDA](https://github.com/JeonKH81/MediStat-EDA) — Clinical EDA report (data quality, missingness, distributions)
- **MediStat-Table1** — Baseline characteristics table (this repo)
- MediStat-KM — Kaplan-Meier / survival (예정)
